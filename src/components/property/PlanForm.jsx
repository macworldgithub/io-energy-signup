          ...
          return (
            ...
            >
              <CardContent sx={{ p: 4 }}>
                ...
                <Typography variant="h3" fontWeight={400} mb={2} lineHeight={1}>
                  {p.rate_display.split(" ")[0]}
                  <Typography component="span" fontSize={16} ml={1}>
                    c/kWh
                  </Typography>
                </Typography>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    py: 1.4,
                    fontWeight: 600,
                    bgcolor: isSelected ? "#ff2d55" : "#ffffff",
                    color: isSelected ? "#fff" : "#111827",
                    border: isSelected ? "none" : "2px solid #d1d5db",
                    "&:hover": {
                      bgcolor: isSelected ? "#e51e45" : "#f1f5f9",
                    },
                  }}
                >
                ...
                <Stack spacing={1.5}>
                  {p.features.map((f, i) => (
                    <Stack direction="row" spacing={1.5} key={i}>
                      <CheckCircleIcon
                        sx={{
                          color: isSelected ? "#ff2d55" : "#10b981",
                        }}
                      />
      ...
      {meterRequired && (
        <Box maxWidth={720}>
          ...
          >
            ...
            <Typography color="text.secondary">
              A smart meter may be required for some plans. We’ll advise during
              signup.
            </Typography>
          </Stack>
        </Box>
